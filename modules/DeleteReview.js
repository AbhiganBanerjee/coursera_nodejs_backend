...
var delReview = express.Router();
//Create a DELETE REST service to modify book review
delReview.delete("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var client, db, isbn, user, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                isbn = req.query.isbn;
                user = req.query.user;
                return [4 /*yield*/, db.collection("books").updateOne({ "isbn": "".concat(isbn) }, { $unset: { "reviews": "" } })];
            case 2:
                result = _a.sent();
                //Validate the result
                if (result.acknowledged) {
                    res.status(200).json({ "Success": "Reviews for the ISBN ".concat(isbn, " posted by the user ").concat(user, " deleted.") });
                }
                else {
