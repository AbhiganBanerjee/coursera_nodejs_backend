...
var getByTitle = express.Router();
//Create a GET REST Service
getByTitle.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var client, db, title, books, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection("books").find({ "title": title }).toArray()];
            case 2:
                books = _a.sent();
                if (books.length > 0) {
