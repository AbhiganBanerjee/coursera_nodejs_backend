...
var getBookIsbn = express.Router();
//Create a GET REST Service
getBookIsbn.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var client, db, isbn, books, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                isbn = req.query.isbn;
                return [4 /*yield*/, db.collection("books").find({ "isbn": isbn }).toArray()];
            case 2:
                books = _a.sent();
                if (books.length > 0) {
